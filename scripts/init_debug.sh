#!/bin/bash
# 快速测试 - 查看初始化是否执行
NOTE="INIT_DEBUG_test"
PYTHON=$UV_INTERNAL__PARENT_INTERPRETER
$PYTHON main.py --mode laprompt --dataset imagenet-r --n_tasks 5 --m 10 --n 50 --rnd_seed 42 \
    --model_name laprompt --opt_name adam --sched_name default --lr 5e-3 --batchsize 64 \
    --memory_size 0 --gpu_transform --online_iter 1 --data_dir /root/autodl-tmp/dataset \
    --note $NOTE --eval_period 5000 --n_worker 4 --rnd_NM \
    ...
    --init_strategy variance_perturb --init_scale 0.01

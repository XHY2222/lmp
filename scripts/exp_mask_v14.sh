#!/bin/bash
# 实验14: 尝试不同的CA参数 - lr=0.005
NOTE="EXP_MASK_v14_CA_lr005"
...
$PYTHON main.py --mode laprompt --dataset imagenet-r --n_tasks 5 --m 10 --n 50 --rnd_seed 1 \
    ...
    --no-use_dynamic_logit_mask --no-use_forgetting_aware_init \
    --laprompt_use_ca --laprompt_ca_lr 0.005 --laprompt_ca_epochs 5 --laprompt_ca_storage variance
